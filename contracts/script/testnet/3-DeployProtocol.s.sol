 ...
 * @notice Deploy all protocol contracts and configure the KiloLend system on KAIA Testnet
 * @dev Usage: 
 *   forge script script/testnet/3-DeployProtocol.s.sol --rpc-url $KAIA_TESTNET_RPC_URL --broadcast --verify
 */
contract DeployProtocol is Script {
    
    // Update these addresses with deployed contracts from previous steps
    address public constant ORACLE = 0xF0b8eaEeBe416Ec43f79b0c83CCc5670d2b7C3Db;
    address public constant USDT = 0x5F7392Ec616F829Ab54092e7F167F518835Ac740;
    address public constant SIX = 0xe438E6157Ad6e38A8528fd68eBf5d8C4F57420eC;
    address public constant BORA = 0xFdB35092c0cf5e1A5175308CB312613972C3DF3D;
    address public constant MBX = 0xCeB75a9a4Af613afd42BD000893eD16fB1F0F057;
